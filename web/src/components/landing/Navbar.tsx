...
const GRADIENT_CTA =
  "rounded-xl bg-linear-to-b from-brand-400 to-brand-600 px-4 py-2 text-sm font-semibold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_8px_22px_-6px_rgba(116,66,237,0.55)] transition-all duration-300 hover:brightness-110 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.25),0_10px_30px_-6px_rgba(116,66,237,0.75)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400/60";
      ...
      <nav className="mx-auto max-w-[1400px]" aria-label="Main">
        ...
        <div
          className={`relative overflow-hidden rounded-2xl border backdrop-blur-xl transition-all duration-300 ${
            isScrolled
              ? "border-white/[0.08] bg-[var(--admin-bg)]/85 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.75)]"
              : "border-white/[0.04] bg-[var(--admin-bg)]/55"
          }`}
        >
