// GlowingEffect — CSS-only port of the llmgateway reference component.
// Replaces framer-motion animate() with a CSS transition on --start; pointer
// tracking updates the conic-gradient origin angle. No motion/react needed.
  ...
  const handleMove = useCallback(
    (e?: MouseEvent | { x: number; y: number }) => {
      ...
      animationFrameRef.current = requestAnimationFrame(() => {
        ...
        // CSS transition on --start replaces framer-motion animate().
